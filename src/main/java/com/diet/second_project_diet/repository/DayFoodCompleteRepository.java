...
public interface DayFoodCompleteRepository extends JpaRepository<DayFoodCompleteEntity, Long>{
    public Integer countByMemberAndDfcDate(MemberInfoEntity member, Date dfcDate);

    public DayFoodCompleteEntity deleteByMemberAndDfcDate(MemberInfoEntity member, Date dfcDate);
