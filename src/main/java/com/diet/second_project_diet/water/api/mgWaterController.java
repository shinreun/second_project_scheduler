...
public class mgWaterController {
    ...
    //하루 섭취량 수정 - 증가
     ...
     // 요일별 달성여부 조회(주 단위)
      ...
      @GetMapping("/dday")
      public ResponseEntity<mgDdayResponseVO> getDdayList(@RequestParam Long miSeq) throws Exception {
         return new ResponseEntity<>(wService.ddaylist(miSeq), HttpStatus.ACCEPTED);
         }
